...
public class ChuScanActivity extends PActivity {
	...
	private void viewInit() {
		...
		mAbHttpUtil = AbHttpUtil.getInstance(ChuScanActivity.this);
		...
		detailAdapter = new DetailAdapter(ChuScanActivity.this);
	...
	private void viewOnclick() {
		...
		scan2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(ChuScanActivity.this, MipcaActivityCapture.class);
		...
		upload.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(detaillist==null||detaillist.size()<1){
					Toast.makeText(ChuScanActivity.this, "请先获取拣货信息", 0).show();
					return;
				}
				mDialogFragment2 = AbDialogUtil.showLoadDialog(ChuScanActivity.this,
	...
	private void getdataJH(String mjhcode){
		...
		mDialogFragment = AbDialogUtil.showLoadDialog(ChuScanActivity.this, R.drawable.icon_share_moments,
				"正在获取拣货信息,请稍候。。。");
		Log.e("chuscan", lastUrl);
		if (NetWorkUtils.isNetworkConnected(ChuScanActivity.this)) {
			mAbHttpUtil.post(lastUrl, new AbStringHttpResponseListener() {
				...
				public void onSuccess(int statusCode, String content) {
					...
					if (code.equals("1")) {
						...
						Toast.makeText(ChuScanActivity.this, jc.get("desc") + "", 0).show();
					}
				}
			...
			Toast.makeText(ChuScanActivity.this, "网络状态异常", 0).show();
		}
	}
		...
		if (NetWorkUtils.isNetworkConnected(ChuScanActivity.this)) {
			...
			mAbHttpUtil.post(statusUrl, new AbStringHttpResponseListener() {
				...
				public void onSuccess(int statusCode, String content) {
					...
					if (code.equals("1")) {
						Toast.makeText(ChuScanActivity.this, "提交完成", 0).show();
					}
				}
			});
		} else {
