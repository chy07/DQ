 ...
 *
 */
public class InputCodeActivity extends PActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		codeOk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(flag.equals("")){
					Toast.makeText(InputCodeActivity.this, "请先扫描单据", 0).show();
					return;
				}
				Intent intent = new Intent(InputCodeActivity.this,ChuScanActivity.class);
		...
		scan_code.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(InputCodeActivity.this, MipcaActivityCapture.class);
